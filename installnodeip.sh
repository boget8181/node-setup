...
NODE=https://github.com/kadena-io/chainweb-node/releases/download/2.15/chainweb-2.15.ghc-8.10.7.ubuntu-18.04.0f05526.tar.gz
...
tar -xvf chainweb-2.15.ghc-8.10.7.ubuntu-18.04.0f05526.tar.gz >> $LOG_FILE 2>&1
